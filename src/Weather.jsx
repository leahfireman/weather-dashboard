      ...
      {options && (
        <div style={{ textAlign: 'center', marginBottom: '20px' }}>
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            <p>{options.data.forecast.forecastday[0].day.avgtemp_f}°F, {options.data.forecast.forecastday[0].day.condition.text}</p>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '20px' }}>
            <div style={{ width: '30%' }}>
              ...
              <p>Average Temperature: {options.data.forecast.forecastday[1].day.avgtemp_f}°F</p>
            ...
            <div style={{ width: '30%' }}>
              ...
              <p>Average Temperature: {options.data.forecast.forecastday[2].day.avgtemp_f}°F</p>
            ...
            <div style={{ width: '30%' }}>
              ...
              <p>Average Temperature: {options.data.forecast.forecastday[3].day.avgtemp_f}°F</p>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                  {location.forecast.map((forecastDay, forecastIndex) => (
                    <div key={forecastIndex} style={{ width: '30%' }}>
                      ...
                      <p>Average Temperature: {forecastDay.day.avgtemp_f}°F</p>
